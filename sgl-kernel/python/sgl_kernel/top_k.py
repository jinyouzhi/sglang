...
def fast_topk_v2(
    ...
    torch.ops.sgl_kernel.fast_topk(score, topk_indices, lengths, topk, row_starts)
    return topk_indices
...
def fast_topk_transform_fused(
    ...
    torch.ops.sgl_kernel.fast_topk_transform_fused(
        score, lengths, dst_page_table, src_page_table, cu_seqlens_q, topk, row_starts
    )
...
def fast_topk_transform_ragged_fused(
    ...
    torch.ops.sgl_kernel.fast_topk_transform_ragged_fused(
        score, lengths, topk_indices_ragged, topk_indices_offset, topk, row_starts
    )
