...
| **Mistral** (Mixtral, NeMo, Small3, Devstral) | `mistralai/Mistral-7B-Instruct-v0.2`             | Open 7B LLM by Mistral AI with strong performance; extended into MoE (“Mixtral”); NeMo Megatron variants for larger scale; Devstral is fine-tuned based on Small3 for coding tasks. |
